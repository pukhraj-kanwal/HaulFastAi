...
export const AppDataSource = new DataSource({
    ...
    database: process.env.DB_DATABASE, // Assuming same database for Phase 1
...
export const initializeDataSource = async () => {
    try {
        ...
        console.log("Order Service Data Source has been initialized!");
    } catch (err) {
        console.error("Error during Order Service Data Source initialization:", err);
